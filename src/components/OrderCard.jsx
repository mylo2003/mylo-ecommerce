...
function OrderCard({ id, price, image, title, visible }) {
  ...
  return (
    <div id={id} className="flex items-center shadow rounded-lg h-[60px] md:w-full my-1 bg-gray-200 border-l border-b border-gray-400 dark:border-dark-accent dark:bg-dark">
