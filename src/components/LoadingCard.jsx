function LoadingCard() {
  return (
    <>
      <div className='w-[210px] h-[250px] rounded-2xl bg-gray-500 shadow-xl animate-pulse'>
        ...
        <div className='relative flex justify-between items-center h-[53px]'>
          <span className='absolute left-3 w-24 h-6 bg-[#D9D9D9] rounded-xl'></span>
          <span className='absolute right-3 w-16 h-6 bg-[#D9D9D9] rounded-xl'></span>
        </div>
      </div>
      <div className='w-[210px] h-[250px] rounded-2xl bg-gray-500 shadow-xl animate-pulse'>
        <figure className='w-[210px] h-[197px] relative overflow-hidden'>
