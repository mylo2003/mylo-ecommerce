...
function MyOrders() {
  ...
  return (
    <Layout>
      <div className='w-[600px] h-[70vh] flex flex-wrap py-3 justify-center items-center rounded-xl px-10 shadow-2xl border border-primary bg-white dark:border-white dark:bg-dark-secondary dark:text-background'>
